...
const Vt = /* @__PURE__ */ Re.define({
  ...
  update(t, e) {
    ...
    let i = v.fromTransaction(e), s = e.annotation(qe.time), l = e.annotation(qe.userEvent);
  ...
  getDeco(t) {
    ...
    for (let a of t.visibleRanges) {
      ...
      for (; !c.next().done; ) {
        ...
        if ((!s || kt(s, r, u, h)) && (o.empty && u <= o.from && h >= o.to ? l.push(Ho.range(u, h)) : (u >= o.to || h <= o.from) && l.push(_o.range(u, h)), l.length > e.maxMatches))
          return x.none;
      }
    }
    return x.set(l);
...
const fe = /* @__PURE__ */ w.define(), st = /* @__PURE__ */ w.define(), _ = /* @__PURE__ */ Re.define({
  create(t) {
...
const Zo = /* @__PURE__ */ x.mark({ class: "cm-searchMatch" }), Xo = /* @__PURE__ */ x.mark({ class: "cm-searchMatch cm-searchMatch-selected" }), ei = /* @__PURE__ */ Ft.fromClass(class {
  constructor(t) {
    this.view = t, this.decorations = this.highlight(t.state.field(_));
  }
  update(t) {
    let e = t.state.field(_);
    (e != t.startState.field(_) || t.docChanged || t.selectionSet || t.viewportChanged) && (this.decorations = this.highlight(e));
  }
...
class ii {
  constructor(e) {
    this.view = e;
    let r = this.query = e.state.field(_).query.spec;
...
function Wi(t) {
  ...
  return s && typeof s == "function" && se.push(p.updateListener.of(s)), se = se.concat(l), q(() => {
    if (W && !F) {
      var R = {
        doc: e,
        selection: r,
  ...
  }, [W, F]), q(() => J(t.container), [t.container]), q(() => () => {
...
//# sourceMappingURL=CodeEditorView-78d4e20d.mjs.map
